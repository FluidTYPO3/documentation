2.1.1 Generating a Provider extension
=====================================
...
Which would generate the extension key `test` authored by `Claus Due` with email `claus@namelesscoder.net` and include page and
