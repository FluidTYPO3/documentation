...
Flux's features - but you will find these explanations much more familiar if you have used Flux at some point in the past.
...
As such, it is __the underlying logic of Flux's Form feature__. It and the __Provider concept__ are the two main new concepts
introduced by Flux and together, they make up around 95% of Flux's feature set. The remaining 5% is a special type of Extbase
Controller which has a few additions to ease working with Flux's APIs.
